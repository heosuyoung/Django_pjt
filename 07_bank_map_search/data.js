...
const allBanks = [
    ...
    "SC제일은행", "한국씨티은행", "수협은행", "대구은행", "부산은행", "광주은행",
    "전북은행", "경남은행", "제주은행", "우체국", "카카오뱅크", "케이뱅크", "토스뱅크"
  ];
  ...
  // 3. locationData 생성
  const locationData = {};
  for (const sido in sidoSigunguMap) {
    locationData[sido] = {};
    for (const sigungu of sidoSigunguMap[sido]) {
      locationData[sido][sigungu] = allBanks.slice(); // 배열 복사
    }
  }
